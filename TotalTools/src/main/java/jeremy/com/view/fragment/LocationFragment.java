...
public class LocationFragment extends Fragment implements RouteSearch.OnRouteSearchListener, com.amap.api.location.AMapLocationListener {
    ...
    private Button bn_go_home;
    private Button bn_go_to_work;
    private Button bn_go_to_anywhere;
    ...
    private void findView(View view) {
        ...
        bn_go_home = (Button) view.findViewById(R.id.bn_go_home);
        bn_go_to_work = (Button) view.findViewById(R.id.bn_go_to_work);
        bn_go_to_anywhere = (Button) view.findViewById(R.id.bn_go_to_anywhere);
